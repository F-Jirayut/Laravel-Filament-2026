...
class MenuResource extends Resource
{
    ...
    // public static function getRouteMiddleware($record): array
    // {
    //     return [
    ...
    {
        return auth()->user()?->can('view_menu') ?? false;
    }

    public static function canCreate(): bool
    {
        return auth()->user()?->can('create_menu') ?? false;
    }

    public static function canEdit($record): bool
    {
        return auth()->user()?->can('update_menu') ?? false;
    }

    public static function canDelete($record): bool
    {
        return auth()->user()?->can('delete_menu') ?? false;
    }
}
